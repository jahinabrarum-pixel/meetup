...
const ControlBar = ({
  ...
  return (
    <footer
      ...
      px-6 py-4 flex items-center justify-between z-40
    ...
    >
      ...
      <div className="flex items-center gap-3 mx-auto sm:mx-0">
        ...
        >
          ...
          <span
            className="absolute -top-1 -right-1 bg-slate-200
            text-slate-800 text-[10px] font-bold px-1.5 py-0.5
        ...
        {isHost ? (
          <button
            ...
            className="p-3.5 rounded-2xl bg-red-600 hover:bg-red-700
            text-white shadow-lg shadow-red-500/25 transition-all
            cursor-pointer border border-red-500 ml-2 font-medium
